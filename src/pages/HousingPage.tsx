...
function HousingPage() {
	...
	const [currentHousingData, setCurrentData] = useState<
		HousingData | undefined | null
	>(null);
		...
		return (
			<main className="main-housing">
				<p className="error-msg">
					Oups! Suite à une erreur, les données du logement n'ont pu
					être chargées.
				</p>
			</main>
		);
					...
					<>
						...
						<section className="general-infos-section">
							<div className="housing-left-part">
								...
								<div className="housing-left-part__tags">
									{currentHousingData.tags.map(
										(tag, index) => (
											<HousingTag key={index} tag={tag} />
										)
									)}
								</div>
							</div>
							...
							<div className="housing-right-part">
								<div className="housing-host">
									<span className="housing-host__name">
										{currentHousingData.host.name}
									</span>

									<span className="housing-host__pic">
										<img
											src={
												currentHousingData.host.picture
											}
											alt={currentHousingData.host.name}
										/>
									</span>
								</div>
								...
								<div className="housing-right-part__rating">
									<StarRating
										rating={currentHousingData.rating}
									/>
								</div>
							</div>
						</section>
						...
						<section className="spec-infos-section">
							<Collapse
								page="housing"
								title="Description"
								textContent={currentHousingData.description}
							/>

							<Collapse
								page="housing"
								title="Équipements"
								textContent={currentHousingData.equipments}
							/>
						</section>
					</>
				)
